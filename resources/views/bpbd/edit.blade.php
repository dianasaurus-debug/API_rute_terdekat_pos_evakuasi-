    ...
    <div class="col-md-12">
        <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Edit Bpbd</li>
            </ol>
        </nav>
    </div>
</div>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title text-center fw-bolder">EDIT BPBD</h5>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('bpbd.update', $bpbd) }}">
                    @csrf
                    @method('PUT')
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="nip"
                                ...
                                value="{{ old('nip', $bpbd->nip) }}" placeholder="Tulis nip">
                            @error('nip')
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="username"
                                ...
                                value="{{ old('username', $bpbd->username) }}" placeholder="Tulis username">
                            @error('username')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email"
                            ...
                            value="{{ old('email', $bpbd->email) }}" placeholder="Tulis email">
                        @error('email')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
