    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title text-center fw-bolder">EDIT USER</h5>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('user.update', $user) }}">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="username"
                                ...
                                value="{{ old('username', $user->username) }}" placeholder="Tulis username">
                            @error('username')
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="name"
                                ...
                                value="{{ old('name', $user->name) }}" placeholder="Tulis nama">
                            @error('name')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="email" name="email"
                                ...
                                value="{{ old('email', $user->email) }}" placeholder="Tulis email">
                            @error('email')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="phone"
                                ...
                                value="{{ old('phone', $user->phone) }}" placeholder="Tulis no hp">
                            @error('phone')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="address" class="form-control @error('address') is-invalid @enderror"
                            id="address" value="{{ old('address', $user->address) }}" placeholder="Tulis alamat">
                        @error('address')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <small class="text-danger">Hanya isi jika ingin mengganti password!</small>
                    <div class="form-row">
                        <div class="form-group col-md-6">
